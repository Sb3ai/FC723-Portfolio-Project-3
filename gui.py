...
# Set window title, size, and resizing option
root.title("Calculator")
root.geometry("400x600")
root.resizable(False , False)


# Create the display box where user input and results will appear
display = tk.Entry (
    root,
    font=("Arial", 30 ), 
    bd=10,
...
# Position the display at the top of the window
...
# Number and operation buttons are placed using grid layout
button_7 = tk.Button(
    buttons_frame,
    text="7",
    font=("Arial", 20),
